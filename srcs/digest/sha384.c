...
void	sha384_init(void* const vctx)
{
	*(sha512_ctx_t*)vctx = (sha512_ctx_t){
		.A = SHA384_INIT_DATA_A,
		.B = SHA384_INIT_DATA_B,
		.C = SHA384_INIT_DATA_C,
		.D = SHA384_INIT_DATA_D,
		.E = SHA384_INIT_DATA_E,
		.F = SHA384_INIT_DATA_F,
		.G = SHA384_INIT_DATA_G,
		.H = SHA384_INIT_DATA_H
	};
}

void	sha384_update(void* const vctx, u8* const msg_u8)
{
...
result_t	sha384_final(void* const vctx, u8* const chunk_msg, u64 chunk_len, u64 total_len)
{
	...
	return u64_to_str(vctx, SHA512_HASHLEN - (sizeof(u64) * 2 * 2) + 1, (sizeof(sha512_ctx_t) / sizeof(u64)) - 2, false);
}
